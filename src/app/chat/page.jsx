								...
								<div className="space-y-3">
									{recommendedProducts.map((product) => (
										<div
											...
											className={`group w-full text-left p-3 rounded-xl border transition-all flex items-center gap-4 hover:shadow-sm cursor-pointer ${
										...
										>
											<Image src={product.image || gambar} alt={product.nama} width={80} height={80} className="h-20 w-20 object-cover rounded-lg" />
											...
											{/* Aksi kanan: Bandingkan + Link ke Detail */}
											<div className="flex items-center gap-2">
												<span
													onClick={(e) => {
														e.stopPropagation(); // supaya tidak mengganti selectedProduct saat klik bandingkan
												...
												<Link
													...
													onClick={(e) => e.stopPropagation()} // jangan trigger select saat klik link
													className="shrink-0 inline-flex items-center gap-1.5 px-3 py-2 rounded-lg border text-sm bg-white hover:bg-slate-50 border-slate-200"
